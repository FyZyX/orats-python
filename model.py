...
class Core(BaseModel):
    ...
    hv_ex_earnings_5_days: float = Field(..., alias='orHvXern5d')
    hv_ex_earnings_10_days: float = Field(..., alias='orHvXern10d')
    hv_ex_earnings_20_days: float = Field(..., alias='orHvXern20d')
    hv_ex_earnings_60_days: float = Field(..., alias='orHvXern60d')
    hv_ex_earnings_90_days: float = Field(..., alias='orHvXern90d')
    hv_ex_earnings_120_days: float = Field(..., alias='orHvXern120d')
    hv_ex_earnings_252_days: float = Field(..., alias='orHvXern252d')
    hv_ex_earnings_500_days: float = Field(..., alias='orHvXern500d')
    hv_ex_earnings_1000_days: float = Field(..., alias='orHvXern1000d')
    close_to_close_hv_ex_earnings_5_days: float = Field(..., alias='clsHvXern5d')
    close_to_close_hv_ex_earnings_10_days: float = Field(..., alias='clsHvXern10d')
    close_to_close_hv_ex_earnings_20_days: float = Field(..., alias='clsHvXern20d')
    close_to_close_hv_ex_earnings_60_days: float = Field(..., alias='clsHvXern60d')
    close_to_close_hv_ex_earnings_90_days: float = Field(..., alias='clsHvXern90d')
    close_to_close_hv_ex_earnings_120_days: float = Field(..., alias='clsHvXern120d')
    close_to_close_hv_ex_earnings_252_days: float = Field(..., alias='clsHvXern252d')
    close_to_close_hv_ex_earnings_500_days: float = Field(..., alias='clsHvXern500d')
    close_to_close_hv_ex_earnings_1000_days: float = Field(..., alias='clsHvXern1000d')
    iv_interpolated_10_day: float = Field(..., alias='iv10d')
    iv_interpolated_20_day: float = Field(..., alias='iv20d')
    iv_interpolated_30_day: float = Field(..., alias='iv30d')
    iv_interpolated_60_day: float = Field(..., alias='iv60d')
