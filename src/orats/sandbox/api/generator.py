...
class FakeDataGenerator:
    ...
    def strike(self, ticker: str = common.random_symbol()) -> common.Json:
        ...
        return {
            ...
            "quoteDate": common.format_timestamp(self._last_update),
            "updatedAt": common.format_timestamp(self._last_update),
            "snapShotEstTime": "1600",
            "snapShotDate": common.format_timestamp(self._last_update),
            "expiryTod": "pm",
        }

    def money_implied(self, ticker: str = common.random_symbol(),
                      days_to_expiration: int = 39) -> common.Json:
        today = self._date
        spot_price = common.random_increase(100, 65)
    ...
    def money_forecast(self, ticker: str = common.random_symbol()) -> common.Json:
